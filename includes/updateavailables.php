              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
                	<tr style="background-color:#000; color:#FFF;">
                    	<td style="text-align:center; width:auto;" class="wow fadeInDown">NAMA</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">DESKRIPSI</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">HARGA</td>
                        ...
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">UBAH</td>
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown"> <center><strong><?php echo 'Rp' .$row['prize'];?></strong></center></td>
