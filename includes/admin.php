...
<head>
    ...
    <title>ADMIN | Penjualan hewan Online</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa fa-coffee"></i> Pemesanan produk</h4></a>
                </div>
    
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Produk <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              <li><a href="addcnp.php"> Tambah Produk </a></li>
                              <li><a href="update_cnp.php"> Update Produk </a></li>
                            </ul>
                        </li>
...
<div class="container">
   <form id="formFilter" name="formFilter" action="admin_reservefilter.php" method="POST" class="pull-left col-md-7 hidden-print">
        ...
        <div class="form-horizontal wow fadeInDown">            
                <label for="filter" class="control-label">  <i class="glyphicon glyphicon-filter"></i> CATATAN</label>
            <div class="col-md-6">  
        ...
        <table class="table table-hover table-condensed wow fadeInDown">
            <thead style="background-color:#282828; color:#fff;">
                <tr>
                    ...
                    <th width="120px" style="text-align:center;"><span class="glyphicon glyphicon-user"></span> Pemesan </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-gift"></span>  Produk </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-tags"></span>  Alamat </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-phone"></span>  Kontak </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-time"></span> Waktu </th>
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="fdid" value="<?php echo $row['id']?>">
        ...
        <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
            ...
            <dt>Produk yang dipesan:</dt>
             <dd><?php echo $row['name'].' ';?><img src="<?php echo $row['image']?>" width="90px;" class="img-responsive img-rounded"></dd>
            <dt>Deskripsi:</dt> <dd><?php echo $row['description'];?></dd>
            <dt>Harga:</dt> <dd><?php echo 'Rp'.$row['prize'];?></dd>
            <dt>Jumlah:</dt> <dd><?php echo $row['oqty'];?></dd>
            <dt>Total:</dt> <dd><?php echo 'Rp'.number_format($total,2,'.',',');?></dd>
            <hr style="border-top: 1px dashed #8c8b8b;
	border-bottom: 1px dashed #fff;">
    		<h4 ><b>RINCIAN PEMBELI</b></h4>
            <dt>Pesanan oleh:</dt> <dd><?php echo $row['cname'].' ';?></dd>
            <dt>Tipe Pesanan:</dt> <dd><?php echo $row['otype'].' ';?></dd>
            <dt>Tanggal Pick-up:</dt> <dd><?php echo $row['datepickup'].' ';?></dd>
            <dt>Tanggal Order:</dt> <dd><?php echo $row['timestamp'];?></dd>
            <dt>Alamat:</dt> <dd><?php echo $row['address'];?></dd>
      ...
      <em style="font-size:12px;color:red; margin-left:20px;">Note: Status Pesanan diperbarui di sini.</em>
      <div class="modal-footer"> 
        <a href="index.php" class="btn btn-default wow fadeInDown">Close</a>
        <button type="button" onClick="printContent('div1');" class="btn btn-info wow fadeInDown"><i class="glyphicon glyphicon-print"></i> Download Bukti Pembelian</button>
        ...
        <button type="submit" class="btn btn-success wow fadeInDown" name="deliver"><i class="glyphicon glyphicon-send"></i> Selesai</button>
      </div>
      </form>
    </div>
  </div>
