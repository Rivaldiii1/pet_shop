  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><img src="images/logo.jpg"  width="15% "/> Penjualan hewan Online</h4></a>
                </div>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="images/ajam.jpeg" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>
            <?php
                session_start();
        ...
        <hr>
            <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
                <dt>Nama Admin</dt><dd><?php echo @$name ?></dd>
        ...
        <hr>
             ...
             <form class="form-horizontal" name="adminacc" id="adminacc" method="POST" action="adminacc_process.php" style="margin-top: 20px;">
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label wow fadeInDown">Nama Admin</label>
                    <div class="col-sm-6">
